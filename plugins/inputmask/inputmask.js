    ...
    var t = {
          ...
          var f = {
            keyEvent: function (e, t, i, c, u) {
              ...
              if (
                ...
                (e.ctrlKey && k === n.keys.x && !("oncut" in v))
              )
                e.preventDefault(),
                  o.handleRemove.call(d, v, k, y),
                  (0, s.writeBuffer)(
                    v,
                    a.getBuffer.call(d, !0),
                    m.p,
                    e,
                    v.inputmask._valueGet() !== a.getBuffer.call(d).join("")
                  );
                ...
                (k === n.keys.Home && !e.shiftKey) || k === n.keys.PageUp
                  ? (e.preventDefault(),
                    a.caret.call(d, v, 0, e.shiftKey ? y.begin : 0, !0))
                    ...
                    ? !0 === e.shiftKey
                      ? ((y.end = a.seekPrevious.call(d, y.end, !0)),
                        ...
                        y.begin >= 0 &&
                          y.end > 0 &&
                          (e.preventDefault(),
                          a.caret.call(d, v, y.begin, y.end)))
            ...
            inputFallBackEvent: function (e) {
              ...
              var o,
                ...
                p = a.caret.call(t, c, void 0, void 0, !0);
              if (d !== u) {
                if (
                  ((o = (function (e, n, r) {
                    for (
                  ...
                  (c.inputmask.shadowRoot || c.ownerDocument).activeElement !==
                    c && c.focus(),
                  (0, s.writeBuffer)(c, a.getBuffer.call(t)),
                  a.caret.call(t, c, p.begin, p.end, !0),
                  t.skipNextInsert &&
            ...
            (t.analyseMask = function (e, t, i) {
              ...
              function x() {
                if ((((s = m.pop()).openGroup = !1), void 0 !== s))
                  if (m.length > 0) {
                    if (
                      ((l = m[m.length - 1]).matches.push(s), l.isAlternator)
                    ) {
                      for (
                ...
                if (p) y();
                  ...
                  switch (o.charAt(0)) {
                    ...
                    case i.quantifiermarker[0]:
                      ...
                      ("*" !== O && "+" !== O) || (O = "*" === T ? 0 : 1),
                        (S.quantifier = { min: O, max: T, jit: E });
                      var D =
                        m.length > 0 ? m[m.length - 1].matches : h.matches;
        ...
        8711: function (e, t, i) {
                  ...
                  default:
                    ...
                    if (d <= h)
                      ...
                      if (
                        ...
                        (!s.call(n, h, u.keepStatic, !0) && v.match.def === g)
                      ) {
                        var k = l.call(n, h);
                        (d >= k || d === h) && (h = k);
                      }
          ...
          function r(e) {
            ...
            return (
              (void 0 !== i.buffer && !0 !== e) ||
                ((i.buffer = a.getMaskTemplate.call(t, !0, o.call(t), !0)),
                    ...
                    if (-1 === j || "string" == typeof j) {
                      ...
                      for (var N = 0; N < R.length; N++) {
                        (A = parseInt(R[N])),
                          (v = []),
                          (i =
                            ("string" == typeof j && m(h, A, E)) || C.slice());
                        var G = _.matches[A];
                        if (G && s(G, [A].concat(o), c)) r = !0;
                          ...
                          G &&
                            G.matches &&
                            G.matches.length > _.matches[0].matches.length)
                        )
                          break;
                        (M = v.slice()), (h = B), (v = []);
                      ...
                      r = s(_.matches[j] || t.matches[j], [j].concat(o), c);
                    if (r) return !0;
                  } else if (
                    r.isQuantifier &&
        ...
        7215: function (e, t, i) {
                  ...
                  if (v) {
                    var g =
                      void 0 !== v.caret
                        ? v.caret
                        : v.pos
                        ? r.seekNext.call(c, v.pos.begin ? v.pos.begin : v.pos)
          ...
          function s(e, t, i, n, o, l) {
            ...
            if (
              ...
              for (; E >= 0; E--)
                if ((d = S.validPositions[E]) && void 0 !== d.alternation) {
                  if (
                    p &&
            ...
            if (void 0 !== u) {
              ...
              for (
                ...
                if (-1 !== S.excludes[v].indexOf(A + ":" + p.alternation)) {
                  T = s.call(x, e, t, i, n, v - 1, l);
                  break;
                }
                for (
                  S.excludes[v].push(A + ":" + p.alternation), h = v;
                  h < r.getLastValidPosition.call(x, void 0, !0) + 1;
                  h++
                )
                  delete S.validPositions[h];
                ...
                if (
                  ...
                  if (
                    ...
                    if (
                      ...
                      !T && !r.isMask.call(g, x, y.keepStatic && 0 === x))
                    )
                      for (
                        var E = x + 1, D = r.seekNext.call(g, x, !1, 0 !== x);
                        E <= D;
                        E++
                      )
                        if (!1 !== (S = w(E, t, i))) {
                          (S = h.call(g, x, void 0 !== S.pos ? S.pos : E) || S),
                            (x = E);
                          break;
                        }
                  }
